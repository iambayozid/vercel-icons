  ...
  >
    <g clipPath="url(#logo-solid_svg__a)">
      ...
      <g mask="url(#logo-solid_svg__b)">
        ...
        />
        <path
          fill="url(#logo-solid_svg__f)"
          d="M11.07 11.789a4.53 4.53 0 0 0-2.185-1.504 4.5 4.5 0 0 0-2.646-.017L0 12.296s5.333 4.055 9.46 3.041l.301-.101c1.71-.507 2.316-2.13 1.309-3.447"
        />
      </g>
    </g>
    <defs>
      <linearGradient
        id="logo-solid_svg__c"
        x1={2.4}
        x2={14.9}
        y1={0.4}
        y2={6.5}
